    ...
    <div class="content_main col-xs-12">
      ...
      <div class="box col-md-6 col-md-offset-3">
        <div class="box-header">
          <img src="images/grsc-logo.jpg" width="120" alt="logogrsc" class="pull-left mr-2">
          <h3 class="box-title" style="text-transform: uppercase; display: inline-block; text-align: center;">HỆ THỐNG CHECK IN KHÁCH</h3>
          <!-- <h4 class="" style="text-align:center;"><i><? //echo $mydate;?></i></h4> -->
