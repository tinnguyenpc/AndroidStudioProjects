...
$filelog = '../mylogs/update_person'.$mydate.'.log';
...
if((isset($_REQUEST["session_app"]))&&(isset($_REQUEST["qrcode"]))){
  ...
  {
  echo $content_err="update_person-false";
  }
  else {
    if(($session_app!="")&&($qr_code!="")&&($r=mysql_query("UPDATE tb_data SET person='$person' where session_app='$session_app' AND qr_code='$qr_code' ",$con)))
    {
      echo $content_err="update_person-true";
    }
    else
    {
      echo $content_err="update_person-false";
