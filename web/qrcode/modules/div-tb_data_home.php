...
<div>
    <table class="table  table-bordered">
        <thead>
            <tr>
                <th class="text-center">Thẻ / Card</th>
                <th class="text-center">Hình ảnh / Image</th>
                <th class="text-center" style="width:10%;">Vào / In</th>
                <th class="text-center" style="width:10%;">Ra / Out</th>
                <th class="text-center">Liên hệ / Contact</th>
                <th class="text-center" style="width:10%;">KTSK / Health checked</th>
        ...
        <tr>
            ...
            <td class="text-center">
                <?
                if($r_tb_qrdata[heath]=="No")
                {
                    echo "Ok";
                }
                elseif($r_tb_qrdata[heath]=="Yes") {
                    echo "No";
                };
                ?>
            </td>
